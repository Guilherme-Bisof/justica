...
<body>
    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="stats-number"><?= $stats['psicologa'] ?></div>
                    <div class="stats-label">Psicólogas</div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <div class="d-flex flex-wrap">
                ...
                <div class="filter-badge">
                    <i class="fas fa-user-md me-2"></i> Psicólogas
                </div>
                <div class="filter-badge active">
                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th><i class="fas fa-user-md me-2"></i> Psicóloga</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?= $usuario['tipo'] === 'psicologa' ? 
                                        htmlspecialchars($usuario['psicologa_nome']) : '-' ?>
                                </td>
                                <td>
